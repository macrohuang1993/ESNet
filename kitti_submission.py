...
from networks.DispNetC_corr_warp_diff import DispNetC
# 2012 data /media/jiaren/ImageNet/data_scene_flow_2012/testing/

parser = argparse.ArgumentParser(description='FADNet')
parser.add_argument('--KITTI', default='2015',
                    help='KITTI version')
parser.add_argument('--datapath', default='KITTI_2015_Stereo/testing/',
                    help='select model')
parser.add_argument('--loadmodel', default='models/kitti_finetune/pretrained_on_sceneflow_run1/best.tar',
                    help='loading model')
